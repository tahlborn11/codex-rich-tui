...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let copy_last_code_block_binding = runtime_keymap
            .as_ref()
            .map(|keymap| keymap.app.copy_code.clone())
            .unwrap_or_else(|| default_keymap.app.copy_code.clone());
